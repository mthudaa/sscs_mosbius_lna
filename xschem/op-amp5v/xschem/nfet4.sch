...
C {lab_wire.sym} 200 -40 2 1 {name=p2 sig_type=std_logic lab=S}
C {lab_wire.sym} 200 -100 0 0 {name=p3 sig_type=std_logic lab=D}
...
C {symbols/nfet_05v0.sym} 180 -70 0 0 {name=M1
L=0.60u
W=0.30u
nf=1
m=4
