...
N 800 -220 800 -180 {lab=Q_N}
N 800 -120 800 -80 {lab=#net5}
N 700 -250 760 -250 {lab=#net3}
N 700 -250 700 -50 {lab=#net3}
N 700 -50 760 -50 {lab=#net3}
N 540 -200 700 -200 {lab=#net3}
N 800 -250 880 -250 {lab=VDD}
N 540 -250 620 -250 {lab=VDD}
N 300 -250 360 -250 {lab=VDD}
N 300 -150 360 -150 {lab=VDD}
N 800 -150 880 -150 {lab=VSS}
N 800 -50 880 -50 {lab=VSS}
...
N 1060 -220 1060 -80 {lab=Q}
N 1020 -250 1020 -50 {lab=Q_N}
N 1060 -250 1160 -250 {lab=VDD}
N 1060 -50 1160 -50 {lab=VSS}
N 800 -200 1020 -200 {lab=Q_N}
...
C {symbols/pfet_05v0.sym} 780 -250 0 0 {name=M7
L=0.50u
W=0.90u
nf=1
m=1
...
C {symbols/nfet_05v0.sym} 780 -150 0 0 {name=M8
L=0.60u
W=0.30u
nf=1
m=1
...
C {symbols/nfet_05v0.sym} 780 -50 0 0 {name=M9
L=0.60u
W=0.30u
nf=1
m=1
...
C {lab_wire.sym} 880 -250 0 1 {name=p3 lab=VDD}
...
C {lab_wire.sym} 880 -150 0 1 {name=p8 lab=VSS}
C {lab_wire.sym} 880 -50 0 1 {name=p9 lab=VSS}
C {symbols/pfet_05v0.sym} 1040 -250 0 0 {name=M10
L=0.50u
W=0.90u
nf=1
m=1
...
C {symbols/nfet_05v0.sym} 1040 -50 0 0 {name=M11
L=0.60u
W=0.30u
nf=1
m=1
...
C {lab_wire.sym} 1160 -250 0 1 {name=p10 lab=VDD}
C {lab_wire.sym} 1160 -50 0 1 {name=p11 lab=VSS}
C {lab_wire.sym} 660 -280 0 1 {name=p12 lab=VDD}
C {lab_wire.sym} 660 -20 2 0 {name=p13 lab=VSS}
C {lab_wire.sym} 1060 -150 0 1 {name=p14 lab=Q}
C {lab_wire.sym} 940 -200 0 1 {name=p15 lab=Q_N}
...
C {lab_wire.sym} 760 -150 0 0 {name=p20 lab=CLK}
...
C {opin.sym} 100 -120 0 0 {name=p25 lab=Q}
C {opin.sym} 100 -100 0 0 {name=p26 lab=Q_N}
